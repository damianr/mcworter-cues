<template>
  <div :class="['flex flex-col gap-8', wrapperClass]">
    <div
      v-for="cue in cues"
      :key="cue.id"
      class="cursor-pointer mb-24 relative group/item transition-opacity duration-300"
      :class="{
    ...
    >
      ...
      <!-- Content -->
      <div
        class="absolute top-[50%] right-8 group-hover/item:opacity-100 group-hover/item:top-[40%] opacity-0 transition-all duration-400"
      >
